...
--
-- Host: localhost    Database: dom-bilcza
-- ------------------------------------------------------
...
INSERT INTO `actor` VALUES (1,'TARAS',3,11,'730,270'),(2,'SCHODY',1,17,'300,310'),(5,'KORYTARZ I',1,6,'522,624'),(6,'KUCHNIA',1,2,'699,775'),(7,'GABINET',1,4,'389,423'),(8,'SZAFKI',3,2,'764,837'),(9,'ŁAZIENKA I',1,5,'368,670'),(10,'WIATROŁAP',1,1,'518,812'),(11,'PRZEJŚCIE DO GARAŻU',1,8,'367,809'),(12,'NAD KOTŁOWNIĄ',1,10,'116,270'),(13,'WEJŚCIE',1,9,'540,900'),(14,'NAD GARAŻEM',3,9,'179,900'),(15,'ŁAZIENKA II',1,15,'390,534'),(16,'SYPIALNIA',1,14,'650,537'),(17,'PAWEŁ',1,13,'684,244'),(18,'KORYTARZ II',1,16,'527,354'),(19,'MACIEK',1,12,'415,120'),(20,'LAMPA BALKON',1,19,'540,660'),(25,'PŁOT ANDRZEJ',3,9,NULL),(26,'PRZY STUDNI',5,9,NULL),(28,'GRILL',11,10,NULL),(30,'SZOPA GARAŻ',1,10,NULL),(31,'ROL_TARAS',25,11,NULL),(32,'Rynny',20,9,'880,530'),(42,'TARAS',11,11,NULL),(43,'LAMPKI BALKONOWE',11,19,NULL);
...
CREATE TABLE `actor_status` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `actor_status` VALUES (2,1,1,'0'),(3,2,1,'0'),(4,3,1,'135'),(5,4,1,'193'),(6,5,1,'0'),(7,6,1,'255'),(8,7,1,'255'),(9,8,1,'0'),(10,9,1,'255'),(11,10,1,'0'),(12,11,1,'0'),(13,12,1,'0'),(14,13,1,'255'),(15,14,1,'0'),(16,14,2,'0'),(17,15,1,'0'),(18,16,1,'0'),(19,16,2,'255'),(20,17,1,'0'),(21,18,1,'0'),(22,19,1,'0'),(23,19,2,'0'),(24,20,1,'0'),(25,21,1,'0'),(26,22,1,'0'),(27,23,1,'0'),(28,24,1,'0'),(29,25,1,'0'),(30,26,1,'0'),(31,27,1,'0'),(32,28,1,'255'),(33,29,1,'0'),(34,30,1,'255'),(35,31,1,'0'),(36,32,1,'0'),(37,33,1,'0'),(38,34,1,'0'),(39,35,1,'0'),(40,36,1,'0'),(41,37,1,'0'),(42,38,1,'0'),(43,39,1,'0'),(44,41,1,'0'),(45,43,1,'0');
...
CREATE TABLE `connection` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `connection` VALUES (2,1,2,'ACTOR',42,1,'NC'),(5,1,5,'ACTOR',25,1,'NC'),(6,1,6,'ACTOR',26,1,'NC'),(8,2,2,'ACTOR',28,1,'NC'),(10,2,4,'ACTOR',30,1,'NC'),(12,2,6,'ACTOR',14,1,'NC'),(89,3,5,'ACTOR',9,1,'NC'),(14,3,2,'ACTOR',5,1,'NC'),(15,3,3,'ACTOR',7,1,'NC'),(16,3,4,'ACTOR',11,1,'NC'),(85,3,1,'ACTOR',6,1,'NC'),(18,3,6,'ACTOR',8,1,'NC'),(19,4,1,'ACTOR',12,1,'NC'),(20,4,2,'ACTOR',1,1,'NC'),(21,4,3,'ACTOR',2,1,'NC'),(22,4,4,'ACTOR',10,1,'NC'),(23,4,5,'ACTOR',13,1,'NO'),(24,4,6,'ACTOR',32,1,'NC'),(25,5,1,'ACTOR',31,1,'NC'),(26,6,1,'SENSOR',27,1,'NC'),(27,7,1,'SENSOR',26,1,'NC'),(60,16,2,'ACTOR',19,1,'NC'),(61,16,3,'ACTOR',16,1,'NC'),(62,16,4,'ACTOR',18,1,'NC'),(88,17,2,'ACTOR',20,1,'NC'),(64,16,6,'ACTOR',17,1,'NC'),(65,17,1,'ACTOR',15,1,'NC'),(87,18,2,'ACTOR',43,1,'NO');
...
INSERT INTO `device` VALUES (1,3,'T1.1.1',11,1),(2,3,'T1.1.2',11,2),(3,3,'T1.1.3',11,3),(4,3,'T1.1.4',11,4),(5,6,'T1.2.1',12,1),(6,8,'T1.2.2',12,2),(7,8,'T1.2.3',12,3),(8,17,'Sypialnia IT',30,4),(9,1,'T1.4.1',14,1),(10,1,'T1.4.2',14,2),(11,1,'T1.4.3',14,3),(12,1,'T1.4.4',14,4),(13,1,'T1.4.5',14,5),(14,1,'T1.4.6',14,6),(15,6,'T1.3.1',13,1),(16,3,'T2.1.1',21,1),(17,3,'T2.1.2',21,2),(18,3,'T2.3.1',23,1),(19,1,'T2.3.2',23,2),(20,1,'T.2.3',23,3);
...
INSERT INTO `device_info` VALUES (1,1,'TYPE','0x3000'),(2,1,'FIRMWARE','1.0.2.1'),(3,1,'BOOTLOADER','2.6'),(4,1,'UNIV_VERSION','1.0 rev.9'),(5,1,'DESCRIPTION','przekaznik M 6ch'),(6,1,'PROCESSOR_ID','000001cf'),(7,1,'VOLTAGE','13.2375366568915'),(8,2,'TYPE','0x3000'),(9,2,'FIRMWARE','1.0.2.1'),(10,2,'BOOTLOADER','2.6'),(11,2,'UNIV_VERSION','1.0 rev.9'),(12,2,'DESCRIPTION','przekaznik M 6ch'),(13,2,'PROCESSOR_ID','0000020c'),(14,2,'VOLTAGE','14.1915933528837'),(15,3,'TYPE','0x3000'),(16,3,'FIRMWARE','1.0.2.1'),(17,3,'BOOTLOADER','2.6'),(18,3,'UNIV_VERSION','1.0 rev.9'),(19,3,'DESCRIPTION','przekaznik M 6ch'),(20,3,'PROCESSOR_ID','0000020b'),(21,3,'VOLTAGE','13.3269794721408'),(22,4,'TYPE','0x3000'),(23,4,'FIRMWARE','1.0.2.1'),(24,4,'BOOTLOADER','2.6'),(25,4,'UNIV_VERSION','1.0 rev.9'),(26,4,'DESCRIPTION','przekaznik M 6ch'),(27,4,'PROCESSOR_ID','000001db'),(28,4,'VOLTAGE','13.1182795698925'),(29,5,'TYPE','0x3000'),(30,5,'FIRMWARE','1.0.7.1'),(31,5,'BOOTLOADER','2.6'),(32,5,'UNIV_VERSION','1.0 rev.9'),(33,5,'DESCRIPTION','ÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ'),(34,5,'PROCESSOR_ID','ff00010c'),(35,5,'VOLTAGE','11.6871945259042'),(36,6,'TYPE','0x3000'),(37,6,'FIRMWARE','1.0.6.22'),(38,6,'BOOTLOADER','2.6'),(39,6,'UNIV_VERSION','1.0 rev.9'),(40,6,'DESCRIPTION','sciemniaczRCsal\0'),(41,6,'PROCESSOR_ID','000002c5'),(42,6,'VOLTAGE','13.41642228739'),(43,7,'TYPE','0x3000'),(44,7,'FIRMWARE','1.0.6.2'),(45,7,'BOOTLOADER','2.6'),(46,7,'UNIV_VERSION','1.0 rev.9'),(47,7,'DESCRIPTION','sciemniaczRCwyk\0'),(48,7,'PROCESSOR_ID','000001d9'),(49,7,'VOLTAGE','13.3567937438905'),(50,8,'TYPE','0x3000'),(51,8,'FIRMWARE','1.0.3.2'),(52,8,'BOOTLOADER','2.6'),(53,8,'UNIV_VERSION','1.0 rev.9'),(54,8,'DESCRIPTION','CzujnikRC Rodz \0'),(55,8,'PROCESSOR_ID','0000021c'),(56,8,'VOLTAGE','14.1617790811339'),(57,9,'TYPE','0x3000'),(58,9,'FIRMWARE','1.0.255.1'),(59,9,'BOOTLOADER','2.6'),(60,9,'UNIV_VERSION','1.0 rev.9'),(61,9,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(62,9,'PROCESSOR_ID','00000210'),(63,9,'VOLTAGE','13.177908113392'),(64,10,'TYPE','0x3000'),(65,10,'FIRMWARE','1.0.255.1'),(66,10,'BOOTLOADER','2.6'),(67,10,'UNIV_VERSION','1.0 rev.9'),(68,10,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(69,10,'PROCESSOR_ID','00000206'),(70,10,'VOLTAGE','13.3866080156403'),(71,11,'TYPE','0x3000'),(72,11,'FIRMWARE','1.0.255.1'),(73,11,'BOOTLOADER','2.6'),(74,11,'UNIV_VERSION','1.0 rev.9'),(75,11,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(76,11,'PROCESSOR_ID','0000020f'),(77,11,'VOLTAGE','13.297165200391'),(78,12,'TYPE','0x3000'),(79,12,'FIRMWARE','1.0.255.1'),(80,12,'BOOTLOADER','2.6'),(81,12,'UNIV_VERSION','1.0 rev.9'),(82,12,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(83,12,'PROCESSOR_ID','00000211'),(84,12,'VOLTAGE','13.4462365591398'),(85,13,'TYPE','0x3000'),(86,13,'FIRMWARE','1.0.255.1'),(87,13,'BOOTLOADER','2.6'),(88,13,'UNIV_VERSION','1.0 rev.9'),(89,13,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(90,13,'PROCESSOR_ID','0000020e'),(91,13,'VOLTAGE','13.41642228739'),(92,14,'TYPE','0x3000'),(93,14,'FIRMWARE','1.0.255.1'),(94,14,'BOOTLOADER','2.6'),(95,14,'UNIV_VERSION','1.0 rev.9'),(96,14,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(97,14,'PROCESSOR_ID','0000020d'),(98,14,'VOLTAGE','13.4760508308895'),(99,15,'TYPE','0x3000'),(100,15,'FIRMWARE','1.0.7.1'),(101,15,'BOOTLOADER','2.6'),(102,15,'UNIV_VERSION','1.0 rev.9'),(103,15,'DESCRIPTION','ÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ'),(104,15,'PROCESSOR_ID','ff00010d'),(105,15,'VOLTAGE','11.6871945259042'),(106,16,'TYPE','0x3000'),(107,16,'FIRMWARE','1.0.2.1'),(108,16,'BOOTLOADER','2.6'),(109,16,'UNIV_VERSION','1.0 rev.9'),(110,16,'DESCRIPTION','przekaznik M 6ch'),(111,16,'PROCESSOR_ID','00000207'),(112,16,'VOLTAGE','14.519550342131'),(113,17,'TYPE','0x3000'),(114,17,'FIRMWARE','1.0.2.1'),(115,17,'BOOTLOADER','2.6'),(116,17,'UNIV_VERSION','1.0 rev.9'),(117,17,'DESCRIPTION','przekaznik M 6ch'),(118,17,'PROCESSOR_ID','00000208'),(119,17,'VOLTAGE','14.1915933528837'),(120,18,'TYPE','0x3000'),(121,18,'FIRMWARE','1.0.2.1'),(122,18,'BOOTLOADER','2.6'),(123,18,'UNIV_VERSION','1.0 rev.9'),(124,18,'DESCRIPTION','przekaznik M 6ch'),(125,18,'PROCESSOR_ID','00000209'),(126,18,'VOLTAGE','14.1319648093842'),(127,19,'TYPE','0x3000'),(128,19,'FIRMWARE','1.0.255.1'),(129,19,'BOOTLOADER','2.6'),(130,19,'UNIV_VERSION','1.0 rev.9'),(131,19,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(132,19,'PROCESSOR_ID','000001d5'),(133,19,'VOLTAGE','14.1021505376344'),(134,20,'TYPE','0x3000'),(135,20,'FIRMWARE','1.0.255.1'),(136,20,'BOOTLOADER','2.6'),(137,20,'UNIV_VERSION','1.0 rev.9'),(138,20,'DESCRIPTION','Button_6CH\0\0\0\0\0\0'),(139,20,'PROCESSOR_ID','00000212'),(140,20,'VOLTAGE','14.2810361681329');
...
INSERT INTO `device_status` VALUES (1,1,1,'0'),(2,1,2,'0'),(3,1,3,'0'),(4,1,4,'0'),(5,1,5,'0'),(6,1,6,'0'),(7,2,1,'0'),(8,2,2,'255'),(9,2,3,'0'),(10,2,4,'255'),(11,2,5,'0'),(12,2,6,'0'),(13,3,1,'255'),(14,3,2,'0'),(15,3,3,'255'),(16,3,4,'0'),(17,3,5,'255'),(18,3,6,'0'),(19,4,1,'0'),(20,4,2,'0'),(21,4,3,'0'),(22,4,4,'0'),(23,4,5,'0'),(24,4,6,'0'),(25,5,1,'0'),(26,5,2,'0'),(27,5,3,'0'),(28,5,4,'0'),(29,6,1,'143'),(30,7,1,'0'),(31,8,1,'0'),(32,9,1,'0'),(33,9,2,'0'),(34,9,3,'0'),(35,9,4,'0'),(36,9,5,'0'),(37,9,6,'0'),(38,10,1,'0'),(39,10,2,'0'),(40,10,3,'0'),(41,10,4,'0'),(42,10,5,'0'),(43,10,6,'255'),(44,11,1,'0'),(45,11,2,'255'),(46,11,3,'0'),(47,11,4,'0'),(48,11,5,'0'),(49,11,6,'255'),(50,12,1,'255'),(51,12,2,'255'),(52,12,3,'0'),(53,12,4,'0'),(54,12,5,'0'),(55,12,6,'0'),(56,13,1,'255'),(57,13,2,'255'),(58,13,3,'255'),(59,13,4,'0'),(60,13,5,'0'),(61,13,6,'0'),(62,14,1,'255'),(63,14,2,'255'),(64,14,3,'255'),(65,14,4,'0'),(66,14,5,'255'),(67,14,6,'255'),(68,15,1,'0'),(69,15,2,'0'),(70,15,3,'0'),(71,15,4,'0'),(72,16,1,'0'),(73,16,2,'0'),(74,16,3,'0'),(75,16,4,'0'),(76,16,5,'255'),(77,16,6,'0'),(78,17,1,'0'),(79,17,2,'0'),(80,17,3,'0'),(81,17,4,'0'),(82,17,5,'0'),(83,17,6,'0'),(84,18,1,'0'),(85,18,2,'255'),(86,18,3,'0'),(87,18,4,'0'),(88,18,5,'0'),(89,18,6,'0'),(90,19,1,'0'),(91,19,2,'0'),(92,19,3,'0'),(93,19,4,'0'),(94,19,5,'0'),(95,19,6,'0'),(96,20,1,'255'),(97,20,2,'0'),(98,20,3,'0'),(99,20,4,'0'),(100,20,5,'0'),(101,20,6,'0');
...
CREATE TABLE `sensor` (
  ...
  `coords` varchar(45) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sensor` VALUES (27,'SALON KOMINEK',34,3,NULL),(26,'SALON WYKUSZ',34,3,NULL);
...
INSERT INTO `sensor_status` VALUES (39,27,1,'143'),(38,26,1,'0');
...
-- Dump completed on 2016-09-13 20:37:14
